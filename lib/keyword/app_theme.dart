...
class AppThemes {
  ...
  static const DARK_BACKGROUND_COLOR = Color.fromRGBO(124, 131, 149, 1.0);
  static const DARK_CONTENT_COLOR = Color.fromRGBO(71, 75, 85, 1.0);
  static const LIGHT_BACKGROUND_COLOR = Color.fromRGBO(248, 250, 252, 1);
  static const LIGHT_CONTENT_COLOR = Color.fromRGBO(29, 161, 242, 1);
  //constants color range for light theme
  //main color
  static const Color _lightPrimaryColor = LIGHT_CONTENT_COLOR;
  //Background Colors
  static const Color _lightBackgroundColor = LIGHT_BACKGROUND_COLOR;
  ...
  //Border Color
  static const Color _lightBorderColor = Colors.white;
  ...
  static const Color _lightBorderErrorColor = Colors.black;

  //constants color range for dark theme
  static const Color _darkPrimaryColor = DARK_CONTENT_COLOR;

  /// 백그라운드 색
  static const Color _darkBackgroundColor = DARK_BACKGROUND_COLOR;

  /// 앱바 색
  static const Color _darkBackgroundAppBarColor = DARK_CONTENT_COLOR;
  ...
  //Border Color
  static const Color _darkBorderColor = Colors.black;
  ...
  static const Color _darkBorderErrorColor = Colors.white;
